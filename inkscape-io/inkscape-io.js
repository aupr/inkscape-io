...
// Inkscape features over Snap
(function() {

    Inkscape.plugin( function( Inkscape, Element, Paper, global ) {
        e = Element.prototype;
        ...
        e.inkscapeRotation = function (minVal, maxVal, minAngle, maxAngle) {
            ...
            this.animate = function (value) {
                ...
                //var me = this;
                Inkscape.animate(pv, val, function (va) {
            ...
            this.animateAutoStart = function () {
                if (timer === null) {
                    pv = minVal;
                    me.animate(maxVal);
        ...
        e.inkscapeVisibility = function() {
            ...
            var animateTime = 300;
            var me = this;
            this.setBlinkDelay = function (ms) {
                blinkDelay = ms;
            };
            this.setAnimateTime = function(ms) {
                animateTime = ms;
            ...
            this.hideAnimate = function () {
                Inkscape.animate(1, 0, function (v) {
                    me.attr({opacity: v});
                }, animateTime);
            };
            this.showAnimate = function () {
                Inkscape.animate(0, 1, function (v) {
                    me.attr({opacity: v});
                }, animateTime);
            };
            this.blinkAnimate = function () {
                Inkscape.animate(1, 0, function (v) {
                    me.attr({opacity: v});
                    if (v === 0) {
                        setTimeout(function () {
            ...
            this.blinkAnimateAutoStart = function () {
                if (timer === null) {
                    me.blinkAnimate();
                    timer = setInterval(function () {
                        me.blinkAnimate();
                    }, (blinkDelay + animateTime) * 2);
                }
            };
            this.blinkAnimateAutoStop = function () {
                if (timer !== null) {
                    clearInterval(timer);
                    timer = null;
                }
        ...
        e.inkscapeArcProgress = function (minVal, maxVal, minAngle, maxAngle) {
            ...
            var radius = b.w>b.h?b.w/2:b.h/2;

            if (parseInt(b.w) === parseInt(b.h)){
                center.x = b.cx;
                center.y = b.cy;
            } else if (b.w > b.h) {
                center.x = b.cx;
                center.y = startDeg < 180 ? b.y : b.y2;
            } else if (b.w < b.h) {
            ...
            this.value = function (value) {
                ...
                var endPoint = {
                    x: center.x + radius * Math.cos(Math.PI*(startDeg + del)/180),
                    y: center.y + radius * Math.sin(Math.PI*(startDeg + del)/180)
                };

                var largeArc = del>(180+startDeg)?1:0;
